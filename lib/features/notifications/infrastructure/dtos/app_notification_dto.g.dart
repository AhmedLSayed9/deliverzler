...
_$_AppNotificationDto _$$_AppNotificationDtoFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_AppNotificationDtoToJson(_$_AppNotificationDto instance) =>
    <String, dynamic>{
