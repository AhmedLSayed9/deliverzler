...
String _$currentAppThemeModeHash() => r'33a471e3b3ba92d877a97cb840e99be8e3d6a6cd';
...
final currentAppThemeModeProvider = Provider<AppThemeMode>.internal(
  ...
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$currentAppThemeModeHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef CurrentAppThemeModeRef = ProviderRef<AppThemeMode>;
String _$platformBrightnessHash() => r'45d60c888829ec39a19ad4496abb7407e1e9ec96';

/// See also [PlatformBrightness].
@ProviderFor(PlatformBrightness)
final platformBrightnessProvider = NotifierProvider<PlatformBrightness, Brightness>.internal(
  PlatformBrightness.new,
  name: r'platformBrightnessProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$platformBrightnessHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
